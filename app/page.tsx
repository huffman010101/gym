  ...
  return (
    <main className="min-h-screen bg-[#0a0a0a] text-white">
      ...
      <nav className="flex items-center justify-between px-6 py-4 max-w-6xl mx-auto">
        ...
        <Link href="/quiz"
          className="bg-orange-500 hover:bg-orange-600 text-white px-5 py-2 rounded-lg text-sm font-semibold transition-all hover:scale-105 active:scale-95">
          Start Free
        </Link>
      </nav>
      ...
      <section className="px-6 pt-16 pb-24 text-center max-w-4xl mx-auto">
        ...
        <Link href="/quiz"
          className="inline-flex items-center gap-2 bg-orange-500 hover:bg-orange-600 text-white px-8 py-4 rounded-xl text-lg font-bold transition-all hover:scale-105 active:scale-95 shadow-lg shadow-orange-500/20">
          Build My Plan <ChevronRight size={20} />
        </Link>
        <p className="text-gray-600 text-sm mt-4">Free · No signup · Takes 2 minutes</p>
      </section>
      ...
      <section className="px-6 py-20 max-w-6xl mx-auto">
        <div className="grid md:grid-cols-3 gap-6">
          {[
            ...
            { icon: Utensils, title: 'Smart Meals',         desc: 'Calorie and macro targets with a rotating meal plan. Hit X on any meal to see alternatives.' },
      ...
      <section className="px-6 py-24 text-center">
        ...
        <p className="text-gray-500 mb-8">Takes less than 2 minutes. No signup required.</p>
        <Link href="/quiz"

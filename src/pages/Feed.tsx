...
const CARDS: FeedCard[] = [
  ...
  { id: 'm2', section: 'Mind', emoji: '🧠', color: 'text-pink-400', bg: 'from-pink-950/60 to-black', title: 'The sacred pause', text: 'Between what happens and how you respond there\'s a gap — that gap is your whole power. One slow breath before any word or action when triggered. Every regrettable text and outburst dies in that pause.', link: '/mind?tab=code' },
  ...
  { id: 'm4', section: 'Mind', emoji: '🧠', color: 'text-pink-400', bg: 'from-pink-950/60 to-black', title: 'Never act at the peak', text: 'Strong emotion = automatic 24-hour delay on anything irreversible. Same options tomorrow, clearer head. The Stoics ran empires on this one rule.', link: '/mind?tab=code' },

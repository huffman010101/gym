...
const CARDS: FeedCard[] = [
  // GYM
  { id: 'g1', section: 'Gym', emoji: '🏋️', color: 'text-orange-400', bg: 'from-orange-950/60 to-black', title: 'The only 3 rules of muscle', text: 'Beat your logbook (one more rep or kg than last time), hit your protein (2g per kg bodyweight), sleep 8 hours. Everything else — the perfect split, the perfect supplement — is noise on top of these three.', link: '/dashboard' },

...
const PHASES: Phase[] = [
  {
    ...
    actions: [
      ...
      { id: 'f3', label: 'Training 3-4×/week started (any consistency > perfection)', link: '/training' },
  ...
  },
  {
    ...
    actions: [
      ...
      { id: 'b2', label: 'Progressive overload tracked — beating the logbook weekly', link: '/training' },

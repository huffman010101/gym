      ...
      <div className="max-w-2xl mx-auto px-5 pt-6">
        ...
        {tab === 'confidence' && (
          <div className="fade-up stagger space-y-4">
            ...
            <Card icon={Flame} title="Why You Feel No Motivation — the dopamine truth" items={[
              ['Your baseline is fried, not broken', 'Laziness usually isn\'t a character flaw — it\'s a dopamine economy problem. TikTok, porn, junk food, and gaming deliver effort-free dopamine spikes all day. Next to that, studying and training feel like they pay in pennies. Your brain isn\'t lazy; it\'s rationally choosing the cheaper hit.'],
              ['The comparison effect', 'After an hour of shorts, a textbook is physiologically boring — your dopamine receptors are downregulated. The fix isn\'t more willpower against the phone; it\'s making the phone less available and letting your baseline recover. Boredom is the feeling of receptors healing.'],
              ['The real "dopamine detox"', 'You can\'t detox dopamine (you\'d die) — you detox the CHEAP sources. 2-week protocol: no shorts/reels feeds (delete or screen-time-lock the apps), no porn, phone out of the bedroom, music/podcasts only when moving. Keep: training, reading, people, sunlight. Days 1-4 feel grey and restless — that\'s withdrawal, not depression. By day 10-14, normal life feels rewarding again and hard work becomes startable.'],
              ['Effort BEFORE reward, permanently', 'The rebuild rule: earn the scroll. Phone time comes after the deep work block, dessert after protein, gaming after training. Sequence alone retrains the brain that effort precedes reward — the exact wiring "lazy" brains have backwards.'],
              ['Motivation follows action — never precedes it', 'Waiting to "feel like it" is the trap: dopamine is released during progress, not before it. Start the task at 10% effort and motivation arrives ~5 minutes in. Action first, feeling second — every disciplined person you admire runs on this order.'],
            ]} />
            <Card icon={Flame} title="The Anti-Laziness Protocol" items={[
              ['The 5-minute contract', 'Commit to just 5 minutes of the avoided thing — gym warm-up, one page, opening the doc. Quitting after 5 is allowed (you almost never will). Starting is 90% of the war; this makes starting trivially small.'],
              ['Shrink the task until it\'s stupid', '"Revise economics" paralyses. "Do 3 flashcards" doesn\'t. If you\'re not starting, the task is too big — cut it in half until resistance disappears. Momentum scales it back up on its own.'],
              ['Design the environment, not the willpower', 'Phone in another room (proximity beats discipline every time), gym bag packed by the door, desk cleared the night before, the app you waste hours on deleted (reinstalling is friction enough). Lazy environments make lazy people — engineer yours.'],
              ['The 3-second rule for tasks', 'Same as approaches: when you notice "I should do X", move toward it within 3 seconds — stand up, open the book, put shoes on. Hesitation is where laziness lives; the gap between impulse and action is the whole battle.'],
              ['Track the streak, protect the streak', 'The daily habit checklists in every section exist for this. A visible streak converts "do I feel like it?" into "do I break the chain?" — a much easier question. Never miss twice: one missed day is life; two is the old you returning.'],
              ['Hard work is a trainable capacity', 'Discipline is literally a muscle — the anterior midcingulate cortex grows when you do things you don\'t want to do. Every cold shower, every session while unmotivated physically builds the brain region of "doing hard things". You\'re not finding discipline; you\'re training it.'],
              ['Boredom is the price of a great life', 'The final reframe: deep work, long training blocks, real studying — they\'re supposed to feel effortful. The modern lie is that everything should be stimulating. Accept 2 hours of boring effort daily and you lap everyone waiting to enjoy it.'],
            ]} />

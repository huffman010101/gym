...
const INDEX: Entry[] = [
  ...
  { label: 'Looks: Mewing & Bone Development', section: 'Looks', path: '/looksmax?tab=techniques', keywords: 'blueprint bone mewing maxilla masseter cheekbone development tongue posture palate mechanism' },
  ...
  { label: 'Looks: Hair & Scalp Care', section: 'Looks', path: '/looksmax?tab=hair', keywords: 'blueprint hair scalp rosemary oil wavy waves dermaroller wash haircut french crop verb' },
  { label: 'Looks: Grooming Detail (brows, lips, teeth)', section: 'Looks', path: '/looksmax?tab=grooming', keywords: 'blueprint grooming eyebrows threading castor oil lips under eyes teeth stubble beard neckline' },
  { label: 'Gym: Posture Routine', section: 'Gym', path: '/programs?tab=posture', keywords: 'blueprint posture apt anterior pelvic tilt rib flare stomach vacuum dead hang wall angels neck training' },
  { label: 'Gym: Posture Routine', section: 'Gym', path: '/programs?tab=posture', keywords: 'back extensions erectors lower back neck thicker stronger harness curls shrugs traps rdl' },
  { label: 'Mind: Aura 0→100 Roadmap', section: 'Mind', path: '/mind?tab=aura', keywords: 'blueprint aura psl levels roadmap presence walk voice high status behaviour tall style fit tailor signature' },
  { label: 'Mind: The Social Edge', section: 'Mind', path: '/mind?tab=charisma', keywords: 'blueprint social edge confidence exposure charisma memorable peak end ford mirror label daily stack' },
  ...
  { label: 'Programs: folding power work into the split', section: 'Gym', path: '/programs?tab=plan', keywords: 'integrate combine mma football power into push pull legs shoulders split which day qualities finishers med ball chest pass suitcase carry pogo isometric how to fit everything in too many sessions recovery four day version fight camp' },
  { label: 'Combat: Shin & body conditioning', section: 'Combat', path: '/combat?tab=tough', keywords: 'shin conditioning kick harder toughen shins rolling bottle periostitis stress fracture forearm blocking body shots taking a punch abs bracing liver knuckle push ups makiwara iron palm chin pain tolerance mental toughness solid firm hard body isometrics' },
  { label: 'Combat: Street fights, fear & opponent types', section: 'Combat', path: '/combat?tab=strategy', keywords: 'street fight how to not be scared fear adrenaline dump nervous bottle it de escalation the fence uk law reasonable force pre emptive multiple attackers weapon knife more skilled opponent smaller faster brawler wrestler southpaw open stance how to beat' },
  { label: 'Mind: Mastering frame', section: 'Mind', path: '/mind?tab=aura', keywords: 'frame hold your frame frame control non reactive over explaining justifying getting tested teasing agree and amplify authority figures composure not needing approval rigid arrogance apologising security presence' },
  { label: 'Football: Pre-match warm-up & stretches', section: 'Football', path: '/football?tab=warmup', keywords: 'pre match warm up warmup stretches dynamic stretching before game static after leg swings lunges activation build up runs half time sub coming on cold ankle taping fifa 11+ what to do before kick off' },
  { label: 'Video Notes — summarise a YouTube video', section: 'Tools', path: '/videonotes', keywords: 'video notes youtube summarise summarize transcript paste link save notes watch later podcast lecture key points takeaways' },
  { label: '★ The Plan — whole programme, one page', section: 'Gym', path: '/programs?tab=plan', keywords: 'the plan my programme simple workout 3 day three day split push legs speed pull which days why everything in one place sprained ankle finisher rehab not healed faster explosive what do i do today monday tuesday wednesday thursday friday full week exercises sets footballer physique bigger arms back explosive legs ankle unstable around games match day fixture' },
  { label: 'Gym: Isometrics & upper-body power', section: 'Gym', path: '/programs?tab=legs', keywords: 'isometrics overcoming yielding wall push immovable pin press hold plyometric push ups med ball chest pass overhead slam explosive pull ups upper body power duel shoulder to shoulder strong football explosive athletic day' },
  { label: 'Gym: Copenhagen planks (groin)', section: 'Gym', path: '/programs?tab=legs', keywords: 'copenhagen plank adductor groin strain prevention short lever long lever knee ankle bench progression protocol 8 week ball squeeze side lying adductor raise nordic injury prevention football grappling inner thigh pulled groin sore' },
  { label: 'Gym: Mobility & flexibility', section: 'Gym', path: '/programs?tab=mobility', keywords: 'flexibility mobility stretching tight hamstrings hips 90/90 couch stretch deep squat hold thoracic rotation shoulder pass through adductor splits kicking height dynamic static pnf contract relax loaded stretching range of motion dorsiflexion how to get flexible' },
  { label: '✦ Know Yourself — values, standards, evidence log', section: 'Mind', path: '/mind?tab=know', keywords: 'know yourself find myself who am i identity values standards non negotiables evidence log confidence unshakeable unbothered unpressed outcome attachment waiting for her to look eye contact approach on my decision appreciation gratitude interactive' },
  { label: 'Game Plan: why you are not pulling', section: 'Mind', path: '/mind?tab=secret', keywords: 'not pulling clubs girls kissed dropped off good looking but no results approach anxiety volume tall 6ft4 looming side by side smiling friends pulling more than me psychology halo effect intimidating spiral club night out game plan' },
  { label: 'Mind: Active listening', section: 'Mind', path: '/mind?tab=charisma', keywords: 'active listening listen better how to listen make people feel heard follow up questions labelling emotions mirroring remember details call back silence interrupting conversational narcissism dont fix validate empathy difficult conversations criticism arguments name eye contact phone away' },
  { label: 'Combat: Using your hips', section: 'Combat', path: '/combat?tab=hips', keywords: 'hips hip rotation punching power rear heel spin pivot slip level change shrimp hip escape bridge upa hip heist hip pressure side control guard passing hip to hip clinch throws sprawl how to use my hips grappling boxing' },
  { label: 'Combat: The martial arts compared', section: 'Combat', path: '/combat?tab=arts', keywords: 'bjj brazilian jiu jitsu wrestling judo sambo boxing muay thai kickboxing karate taekwondo krav maga aikido wing chun which martial art should i do how to start beginner first class belts grading gym choosing mcdojo self defence gi no gi' },
  { label: 'MMA: Strength & Power (force production)', section: 'Combat', path: '/combat?tab=gym', keywords: 'mma strength conditioning force production power punching power kinetic chain rotational med ball throw rate of force development rfd plyometrics elastic neck training grip nordic copenhagen fight camp periodisation taper conditioning energy systems zone 2 aerobic benchmarks pro fighter plan' },
  { label: 'MMA: Technique drills', section: 'Combat', path: '/combat?tab=drills', keywords: 'mma drills shadowboxing heavy bag double end bag pad work wrestling penetration step sprawl shrimp bridge technical stand up granby positional sparring flow roll constraint games how to learn a technique solo drills at home practice' },
  { label: 'Football: acceleration, cutting & ankles', section: 'Football', path: '/football?tab=speed', keywords: 'acceleration first five metres shin angle wall drive sled hill sprint change of direction deceleration braking penultimate step cutting angles 5-0-5 reactive agility ankle stiffness pogo calf soleus balance proprioception sprain boots studs' },
  ...
  { label: 'Stoicism & Emotional Control', section: 'Mind', path: '/mind?tab=code', keywords: 'stoic stoicism emotions control anger marcus aurelius seneca epictetus being a man masculinity discipline code' },
  ...
  { label: 'Self-Talk Scripts', section: 'Mind', path: '/mind?tab=confidence', keywords: 'self talk affirmations inner critic mindset scripts' },

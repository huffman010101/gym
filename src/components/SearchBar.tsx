...
const INDEX: Entry[] = [
  ...
  { label: 'Programs: folding power work into the split', section: 'Gym', path: '/programs?tab=week', keywords: 'integrate combine mma football power into push pull legs shoulders split which day qualities finishers med ball chest pass suitcase carry pogo isometric how to fit everything in too many sessions recovery four day version fight camp' },
  ...
  { label: '★ The Plan — whole programme, one page', section: 'Gym', path: '/programs?tab=plan', keywords: 'the plan my programme workout everything in one place what do i do today monday tuesday wednesday thursday friday full week exercises sets footballer physique bigger arms back explosive legs ankle unstable around games match day fixture' },
  { label: 'Gym: Your split explained (which days, why)', section: 'Gym', path: '/programs?tab=week', keywords: 'what split should i do push pull legs shoulders functional athletic day 5 day upper lower how to structure my week bigger legs and upper body football stronger faster leg finisher priority' },
  { label: 'Gym: Isometrics & upper-body power', section: 'Gym', path: '/programs?tab=explosive', keywords: 'isometrics overcoming yielding wall push immovable pin press hold plyometric push ups med ball chest pass overhead slam explosive pull ups upper body power duel shoulder to shoulder strong football explosive athletic day' },

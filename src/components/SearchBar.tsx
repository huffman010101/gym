...
const INDEX: Entry[] = [
  ...
  { label: '★ The Plan — whole programme, one page', section: 'Gym', path: '/programs?tab=plan', keywords: 'the plan my programme workout split which days why everything in one place sprained ankle rehab not healed what do i do today monday tuesday wednesday thursday friday full week exercises sets footballer physique bigger arms back explosive legs ankle unstable around games match day fixture' },

...
const INDEX: Entry[] = [
  ...
  { label: 'Style & Colours', section: 'Looks', path: '/looksmax?tab=style', keywords: 'style colours colour clothes outfit wardrobe capsule undertone contrast glasses sunglasses archetype fit social media presence pose posing photos photography camera framing high value photo iphone editing' },

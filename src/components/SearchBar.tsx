...
const INDEX: Entry[] = [
  ...
  { label: 'Morning Routine', section: 'Uni', path: '/uni?tab=morning', keywords: 'morning routine wake up early light water phone cold shower caffeine coffee breakfast protein snooze grogginess energy start day productive' },
